...
The Stripe Model Context Protocol (MCP) defines a set of [tools](https://docs.stripe.com/mcp.md#tools) that AI agents can use to interact with the Stripe API and search our knowledge base (including documentation and support articles). As you work with your agent, it can use these tools to answer questions or complete tasks.

If you’re using an agent to help build or operate your Stripe integration, [connect it](https://docs.stripe.com/mcp.md) to our MCP server.
...
[Learn more](https://docs.stripe.com/agents.md) about agents.
